...
Interface leve com OpenCV
 ✅ Como funciona
O sistema segue um fluxo contínuo:
Captura de imagem da câmera
Processamento com o modelo YOLOv8
Identificação de objetos e suas localizações
...
Contagem de objetos
Integração com GPU
Deploy em aplicações reais (segurança, monitoramento, etc.)
 ✅ Objetivo
Demonstrar na prática a aplicação de inteligência artificial em visão computacional, com foco em desempenho e organização de código.
▶️ Como executar no Windows 10 (via terminal)
